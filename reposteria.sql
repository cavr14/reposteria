...
--
-- Servidor: 127.0.0.1
-- Tiempo de generación: 07-12-2024 a las 21:45:18
...
INSERT INTO `detalle_pedido` (`ID_detalle`, `ID_pedido`, `ID_producto`, `ID_sabor`, `ID_size`, `ID_top`, `ID_cubierta`, `ID_relleno`, `cantidad`, `precio`, `created_at`, `updated_at`) VALUES
(3, 8, 1, 1, 1, 2, 2, 2, 1, NULL, '2024-12-08 02:23:00', '2024-12-08 02:23:00');
...
(5, '2024_12_07_195531_create_pedidos_table', 2),
(6, '2024_12_07_200540_add_timestamps_to_pedido_table', 3);
...
INSERT INTO `pedido` (`ID_pedido`, `fecha_pedido`, `fecha_entrega`, `ID_usuario`, `total`, `ID_detalle`, `created_at`, `updated_at`) VALUES
(8, NULL, '2024-12-14 00:00:00', 1, NULL, NULL, '2024-12-08 02:23:00', '2024-12-08 02:23:00');
